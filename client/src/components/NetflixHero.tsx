        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-dharma-black/70 text-gray-600 hover:bg-dharma-white hover:text-dharma-black font-semibold px-8 py-3 text-lg backdrop-blur-sm transition-all duration-200 shadow-lg hover:shadow-xl"
              onClick={onAddToList}
            >
              <Plus className="w-6 h-6 mr-2 text-gray-600 hover:text-dharma-black" />
              My List
            </Button>
          </div>
        </div>
